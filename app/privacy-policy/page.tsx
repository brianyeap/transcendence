    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-5 py-8 sm:px-7">
      ...
      <Section title={t("section1Title")}>
        ...
        <ul className="mt-2 flex list-disc flex-col gap-1.5 pl-5">
          ...
          <li>{t("section1Items.username")}</li>
          <li>{t("section1Items.matchRecords")}</li>
          <li>{t("section1Items.tradingActivity")}</li>
          <li>{t("section1Items.matchOutcomes")}</li>
        </ul>
      </Section>
      ...
      <Section title={t("section3Title")}>
        ...
        <ul className="mt-2 flex list-disc flex-col gap-1.5 pl-5">
          <li>{t("section3Items.runMatches")}</li>
          <li>{t("section3Items.showStats")}</li>
          <li>{t("section3Items.matchHistory")}</li>
